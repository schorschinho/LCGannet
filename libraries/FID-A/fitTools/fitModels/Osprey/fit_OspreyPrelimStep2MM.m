...
[x,~,~,~,~,~,J] = lsqnonlin(@(x) fit_Osprey_PrelimStep2_ModelMM(x, inputData, inputSettings), x, lb, ub, opts ); % Run solver with soft constraints
...
function [fitParamsFinal,J] = fit_Osprey_PrelimStep2_finalLinearMM(x, inputData, inputSettings)
